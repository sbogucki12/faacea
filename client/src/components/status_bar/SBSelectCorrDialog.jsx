...
class SBSelectCorrDialog extends React.Component {
  handleClose = () => {
...
SBSelectCorrDialog.propTypes = {
  classes: PropTypes.object.isRequired,
  onClose: PropTypes.func,
  selectedValue: PropTypes.string,
};

const SBSelectCorrDialogWrapped = withStyles(styles)(SBSelectCorrDialog);
export default SBSelectCorrDialogWrapped; 