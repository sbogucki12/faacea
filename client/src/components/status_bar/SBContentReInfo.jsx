...
import SBReInfoDialogWrapped from './SBReInfoDialog';
...
class SBContentReInfo extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            open: false
...
SBContentReInfo.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(SBContentReInfo);