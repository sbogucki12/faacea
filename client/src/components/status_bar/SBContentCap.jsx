...
import SBCapDialogWrapped from './SBCapDialog';
...
class SBContentCap extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            open: false
...
SBContentCap.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(SBContentCap);