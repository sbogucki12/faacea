...
import { PieChart, Pie, Tooltip, Label, LabelList, Cell } from 'recharts';
          ...
          <div>
            <Paper className={classes.paperRoot} elevation={6} align='center'>
                ...
                <PieChart width={600} height={250}>
                    ...
                    <Label value={complianceData.name} />
                    </Pie>
                    <Tooltip />                 
                </PieChart>
                <br />
                <Button variant="outlined" className={classes.button} align='center'>
                    {`Close`}
                </Button>
                <br />
            </Paper>
